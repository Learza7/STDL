...
public class Couple implements Expression {
	...
	public Fragment getCode(TAMFactory _factory) {
		...
		// Generate code for the first expression in the couple
		Fragment firstCode = this.first.getCode(_factory);
		_result.append(firstCode);
		
		// Generate code for the second expression in the couple
		Fragment secondCode = this.second.getCode(_factory);
		_result.append(secondCode);
